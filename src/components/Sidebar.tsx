...
export const Sidebar: React.FC<SidebarProps> = ({ screenSize }) => {
  ...
  return (
    <div
      className={`bg-white flex flex-col h-full shadow-sidebar border-r border-brand-gray-200 ${
        screenSize === "mobile"
          ? "w-80 min-w-80"
          : screenSize === "tablet"
            ? "w-72 min-w-72"
    ...
    >
      ...
      >
        ...
        {screenSize === "mobile" && (
          <div className="relative">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-brand-dark/40" />
            <input
              type="text"
              placeholder="Search projects..."
              className="w-full pl-10 pr-4 py-2 bg-brand-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-success/20"
            />
          </div>
        )}
      </div>
        ...
        >
          ...
          {screenSize === "mobile" && (
            <div className="space-y-3">
              <h3 className="text-sm font-semibold text-brand-dark/70 uppercase tracking-wide">
                Quick Actions
              </h3>
          ...
          <div>
            <div className="flex items-center justify-between mb-0">
              <span
                className={`font-bold text-brand-dark/50 ${
            ...
            {projectsExpanded && (
              <div className="relative">
                ...
                >
                  {/* All projects */}
                  <div className="relative">
                    <div className="absolute -left-4 lg:-left-6 top-2 w-3 lg:w-4 h-px bg-brand-gray-300"></div>
                    <div
                      className={`px-3 lg:px-4 py-2 rounded-2xl text-brand-dark/50 cursor-pointer hover:bg-brand-gray-50 transition-colors ${
                        screenSize === "mobile"
                          ? "text-sm font-medium"
                  ...
                  <div className="relative">
                    <div className="absolute -left-4 lg:-left-6 top-2 w-3 lg:w-4 h-px bg-brand-gray-300"></div>
                    <div
                      className={`px-3 lg:px-4 py-2 rounded-2xl bg-brand-gray-200 text-brand-dark cursor-pointer ${
                        screenSize === "mobile"
                          ? "text-sm font-medium"
                          : "text-base font-semibold"
                      }`}
          ...
          {screenSize === "mobile" && (
            <div>
              <h3 className="text-sm font-semibold text-brand-dark/70 uppercase tracking-wide mb-4">
                Recent Activity
              </h3>
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3 p-3 bg-brand-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-brand-dark/60">5 minutes ago</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div
        className={`border-t border-brand-gray-100 ${
          screenSize === "mobile" ? "p-4" : "p-6 lg:p-7 pt-0 lg:pt-0"
        }`}
      >
        <div className="bg-brand-gray-200 rounded-3xl p-1 flex">
          {/* Light Mode - Active */}
          <div className="flex-1 flex items-center justify-center bg-white rounded-2xl px-3 lg:px-4 py-2 shadow-soft">
            <svg
              className={`mr-2 ${
          ...
          {/* Dark Mode */}
          <div className="flex-1 flex items-center justify-center px-3 lg:px-4 py-2">
            <svg
